      ...
      if (username) {
        ...
        try {
          ...
          if (response.data.suggestions && response.data.suggestions.length > 0) {
            setUserSuggestion(response.data.suggestions)
    ...
    <div className="flex justify-center items-center min-h-screen bg-gray-100">
      <div className="w-full max-w-md p-8 bg-white rounded-lg shadow-md">
        <div className="text-center">
          ...
          <p className="mb-4">Sign up to start your anonymous message</p>
        </div>
        <Form {...form}>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  {isUserSuggestion && userSuggestion.length > 0 && (
                    <div className="mt-2">
                      <p>Suggestions:</p>
                  ...
                  <FormDescription>
                    {!isUserSuggestion && 'Enter Your Username'}
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
